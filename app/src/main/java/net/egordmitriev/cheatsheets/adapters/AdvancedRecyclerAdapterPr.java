...
import net.egordmitriev.cheatsheets.widgets.presenters.Presenter;
...
public abstract class AdvancedRecyclerAdapterPr<TD extends Presenter, TVH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<TVH> {
	...
	public void setAll(List<TD> models) {
		mData.beginBatchedUpdates();
